...
There have been cases \textcolor{red}{(don't mention the name?)} \hh{XXX sounds good!}
where the \hh{the evidence and testimony on} wire cut \hh{evidence} played a crucial role in the criminal investigation \hh{and conviction of a defendant}.
However,
