...
\midrule\addlinespace[2.5pt]
\texttt{x3p-files} & folder containing 120 topographic 3d scans of aluminum wire cuts in x3p format & \autoref{sec-cutting-wires} \\ 
\texttt{meta.csv} & meta information for each cut with tool, blade, and location information (csv format) & \autoref{sec-cutting-wires} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Manual derivatives} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{profiles} & folder of files with manually extracted profiles (csv format) & \autoref{sec-extract-profiles} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Computational derivatives} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{signals} & folder of signals, processed from corresponding profile (csv format) & \autoref{sec-filtered-signals} \\ 
CCF values & CCF values of all pairwise aligned signals in 1 CSV & \autoref{sec-align-signals} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Image files} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{aligned-signals} & pictures of pairwise aligned signals from same sources in PNGs & \autoref{sec-align-signals} \\ 
\bottomrule
\end{tabular*}
