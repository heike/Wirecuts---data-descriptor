...
Firearm and Toolmark Examiners (AFTE), as one of three types:
\emph{identification}, where the marks are believed to be made by the
same source; \emph{elimination}, where the marks are believed to be made
by different tools; and \emph{inconclusive}, where similarities or
dissimilarities between marks are insufficient to allow either
identification or elimination. This process has been criticized by the
National Research Council (NRC) \citep{nas2009} and the President's
Council of Advisors on Science and Technology (PCAST) \citep{pcast} for
its lack of objectivity and the absence of quantifiable measurements,
such as error rates.
