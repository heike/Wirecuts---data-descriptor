...
\begin{tabular*}{0.95\linewidth}{@{\extracolsep{\fill}}>{\raggedright\arraybackslash}p{\dimexpr 0.522\linewidth -2\tabcolsep-1.5\arrayrulewidth}|>{\raggedright\arraybackslash}p{\dimexpr 0.244\linewidth -2\tabcolsep-1.5\arrayrulewidth}>{\raggedright\arraybackslash}p{\dimexpr 0.244\linewidth -2\tabcolsep-1.5\arrayrulewidth}}
\toprule
 & Description & Section \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Raw data} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{scans/} & folder containing 120 topographic 3d scans of aluminum wire cuts (x3p format) & \protect\hyperref[sec-cutting-wires]{Cutting Wires} \\ 
...
\midrule\addlinespace[2.5pt]
\texttt{data-derived/wire-signals.csv.zip} & signals processed from corresponding profile (CSV format) & \protect\hyperref[sec-filtered-signals]{Filtered Signals} \\ 
\texttt{data-derived/ wire\_pairwise\_ccf.csv.zip} & CCF values of all pairwise aligned signals (CSV format) & \protect\hyperref[sec-align-signals]{Align Signals} \\ 
\midrule\addlinespace[2.5pt]
...
\texttt{assessment/analysis-manual/ processing-wires.html} & display of pairwise aligned signals from the same sources (HTML format) & \protect\hyperref[sec-align-signals]{Align Signals} \\ 
\bottomrule
\end{tabular*}
