...
\midrule\addlinespace[2.5pt]
\texttt{x3p-files} & folder containing 120 topographic 3d scans of aluminum wire cuts in x3p format & \protect\hyperlink{sec-cutting-wires}{Cutting wires} \\ 
\texttt{meta.csv} & meta information for each cut with tool, blade, and location information (csv format) & \protect\hyperlink{sec-cutting-wires}{Cutting wires} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Manual derivatives} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{profiles} & folder of files with manually extracted profiles (csv format) & \protect\hyperlink{sec-extract-profiles}{Extract profiles} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Computational derivatives} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{signals} & folder of signals, processed from corresponding profile (csv format) & \protect\hyperlink{sec-filtered-signals}{Filtered signals} \\ 
CCF values & CCF values of all pairwise aligned signals in 1 CSV & \protect\hyperlink{sec-align-signals}{Align signals} \\ 
\midrule\addlinespace[2.5pt]
\multicolumn{3}{>{\raggedright\arraybackslash}m{0.95\linewidth}}{Image files} \\[2.5pt] 
\midrule\addlinespace[2.5pt]
\texttt{aligned-signals} & pictures of pairwise aligned signals from same sources in PNGs & \protect\hyperlink{sec-align-signals}{Align signals} \\ 
\bottomrule
\end{tabular*}
