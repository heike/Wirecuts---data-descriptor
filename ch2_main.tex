...
Profiles}, how we filter signals from profiles in
...
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{images/plier-tip.png}
...
\includegraphics[width=\linewidth,height=0.15\textheight,keepaspectratio]{images/wire-microscope-062524.JPG}
...
\includegraphics[width=\linewidth,height=0.33\textheight,keepaspectratio]{images/T1AW-LI-R2-4edges.png}
...
\caption{\label{fig-cut-tent-scan}(a) A Kaiweets KWS-105 wire cutter
with inner, middle, and outer locations marked. (b) A confocal
microscope used to scan wire-cut surfaces. (c) Four samples obtained
from blades A, B, C, and D after separating the cut edges.
\tom{Figure width and height are tuned manually.}
\tom{For full figure requirements, see \href{https://www.nature.com/sdata/publish/submission-guidelines\#figures}{https://www.nature.com/sdata/publish/submission-guidelines\#figures}.}}
...
\includegraphics[width=\linewidth,height=0.28\textheight,keepaspectratio]{images/T1AW-LI-R1-profiles.png}
...
\includegraphics[width=\linewidth,height=0.13\textheight,keepaspectratio]{images/T1AW-LI-R1-profiles-plot.png}
...
\includegraphics[width=\linewidth,height=0.13\textheight,keepaspectratio]{images/T1AW-LI-R1-signals-plot.png}
...
\caption{\label{fig-T1AW-LI-R1-profiles-signals}(a) A dark-blue profile
line drawn across the scan striations. (b) The profile function
extracted along the line in (a). (c) Raw and filtered signals obtained
from the profile function in (b).}
...
Figure~\ref{fig-signals-pair-alignment}, shown earlier in
\hyperref[sec-align-signals]{Align Signals}, matches our expectation for
signals from the same sources. For different sources, we arbitrarily
...
discussed in \hyperref[sec-methods]{Methods} and
\hyperref[sec-technical-validation]{Technical Validation}, as described
in Table~\ref{tbl-code-overview}. All results are reproducible using the
provided code.
