...
model KWS-105,
as shown in @fig-cut-tent-scan-a,
...
giving us 4 samples.
Here,
we are showing AB and CD sides in @fig-cut-tent-scan-b,
...
shown in Figure @fig-cut-tent-scan-c,
...
::: {#fig-cut-tent-scan layout="[[24, -2, 24, -2, 24]]" fig-env="figure"}

![](images/kaiweet-label-062524.JPG){#fig-cut-tent-scan-a height=24%}

![](images/T1AW-LI-R2-4edges.png){#fig-cut-tent-scan-b height=24%}

![](images/wire-microscope-062524.JPG){#fig-cut-tent-scan-c height=24%}

\(a) A Kaiweets wire cutter of model KWS-105 was used to cut the wire. \tom{we don't have another high resolution pic showing wirecutter cutting wire} (b) A tent structure created by blade AB. After separating 2 tent structures by the connecting position, we obtained 2 samples - 1 sample from blade A and B. (c) A confocal microscope was used to scan the wire surfaces. \tom{need an extra pic of the tip} \tom{| full requirements see \href{https://www.nature.com/sdata/publish/submission-guidelines\#figures}{https://www.nature.com/sdata/publish/submission-guidelines\#figures}}
:::
...
Cleveland et al. [@clevelandLocalRegressionModels1992]
...
see \href{https://heike.github.io/Wirecuts/data-descriptor/README.md}{Github repo}.
