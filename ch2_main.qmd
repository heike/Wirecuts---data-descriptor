...
authors: 
  ...
  - name: Jeff Salyards
    ...
    email: jdsal@msn.com
    corresponding: false
  - name: \tom{order? Jeff the last? check details? affiliations? Middle name for Alicia?}
    corresponding: false  
affiliations: 
  - id: 1
