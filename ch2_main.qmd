...
Each record links a scan's relative file path and unique identifier to its tool, cutting edge, blade location, replicate, and dimensions in pixels.
...
::: {#tbl-profile-structure tbl-cap="Structure of any of the `profile-....csv` files." tbl-pos="hbt"}
