...
\begin{table}
    ...
    \begin{tabular}{c|ccc|cc}
        \toprule
        & \multicolumn{3}{c|}{\textbf{Average CCF}} & \multicolumn{2}{c}{\textbf{Difference}} \\
        \cmidrule(lr){2-4} \cmidrule(lr){5-6}
        Edge & Replicate & Staging & Acquisition & Staging - Replicate & Acquisition - Staging \\
        \midrule
        A & 0.840 & 0.961 & 0.992 & 0.121 & 0.031 \\
        B & 0.908 & 0.922 & 0.939 & 0.014 & 0.017 \\
        C & 0.835 & 0.952 & 0.959 & 0.117 & 0.007 \\
        D & 0.900 & 0.966 & 0.986 & 0.066 & 0.020 \\
        \bottomrule
    \end{tabular}
