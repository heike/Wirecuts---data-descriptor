...
Wire cut data is a type of forensic tool mark data used to assess similarity of striations left on the surface by a wire cutter.
...
In this study,
we follow the same path and provide a data set of wire cut scans,
...
as discussed in [Methods](#sec-methods) and [Technical Validation](#sec-technical-validation). [Code availability](#sec-code-availability) discusses where these codes are available online.
We hope this pipeline developed using this data set to be further generalized and applied to real crime scenes to help investigators draw conclusions based on real wire cut data.
