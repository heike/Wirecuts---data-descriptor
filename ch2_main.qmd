...
Cut surfaces were scanned at 20x magnification using a Confocal Sensofar Microscope [@fig-cut-tent-scan b] and exported to \texttt{x3p} format (ISO 25178-72:2017/Amd 1:2020) with a lateral resolution of 0.645 x 0.645 micrometers per pixel and a vertical resolution of 0.1 micron.
...
T__W-L_-R_
 ...
 +---------- Tool: 1, 2, 3, 4, or 5
```
For example, T1AW-LI-R1 denotes the first replicate of a piece cut by edge A with tool 1 at the inner location.
To minimize errors in the sampling protocol, two team members cut and labeled the wires together.
One team member then scanned the samples in a specified order and assigned names to the scans according to the above convention.
