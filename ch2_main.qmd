...
This hardness allows the tools to leave marks while helping the cut samples resist damage during handling under the microscope.
...
The complete design therefore yields 5 tools $\times$ 3 locations $\times$ 2 replicates $\times$ 4 cut surfaces = 120 scans.
...
We first extracted representative profiles from the scans.
