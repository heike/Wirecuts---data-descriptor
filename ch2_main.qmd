...
::: {#fig-cut-tent-scan layout="[[20, -2, 32, -2, 20]]" fig-env="figure"}

![](images/kaiweet-label-062524.JPG){#fig-cut-tent-scan-a height=14%}

![](images/T1AW-LI-R2-4edges.png){#fig-cut-tent-scan-b height=22%}

![](images/wire-microscope-062524.JPG){#fig-cut-tent-scan-c height=14%}
