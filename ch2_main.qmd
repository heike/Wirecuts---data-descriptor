...
For each of the five wire cutters, we made two replicate cuts at each of three blade locations (inner, middle, and outer).
...
@fig-cut-tent-scan (a) shows the three blade locations.
A 4-inch wire segment was used for each replicate and divided into two 2-inch sides, AB and CD.
Each side was separated along the bend into two pieces.
The resulting pieces comprise four cut surfaces (A, B, C, D).
...
The scans were saved in \texttt{x3p} format.
The microscope is shown in @fig-cut-tent-scan (b).
