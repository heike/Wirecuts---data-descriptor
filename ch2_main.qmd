...
authors: 
  ...
  - name: Heike Hofmann
    ...
    corresponding: false
  - name: Curtis Mosher, Alicia Carriquiry, Eden Amin, Jeff Salyards
    affiliations:
      - ref: 1
      - ref: 3
    corresponding: false  
...
Studies such as those by @chuAutomaticIdentificationBullet2013 and [@vorburgerApplicationsCrosscorrelationFunctions2011, @vorburgerTopographyMeasurementsApplications2015] have demonstrated the efficacy of using numerical methods to improve accuracy and consistency in tool mark analysis.
