...
based on real wire cut data. \tom{
We first cut the wire and collect the data.
Then,
we conduct numerical comparisons between 2 replicates by extracting profiles, filtering signals and aligning signals.}
