...
cross-correlation function (CCF) values. Then, a technical validation
was conducted to further compare signals from different sources also
match our assumption. We hope this pipeline developed using this data
